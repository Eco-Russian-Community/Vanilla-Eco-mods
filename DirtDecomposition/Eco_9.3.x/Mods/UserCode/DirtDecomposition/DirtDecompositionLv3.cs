...
namespace Eco.Mods.TechTree
{
    ...
    public partial class DirtDecayLv3Recipe :
        RecipeFamily
    {
        public DirtDecayLv3Recipe()
        {
            ...
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "DirtDecayLv3",
                    Localizer.DoStr("Dirt Decay Lv3"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(DirtDecayLv3Recipe), 2.5f, typeof(MiningSkill));     
            this.Initialize(Localizer.DoStr("Dirt Decay Lv3"), typeof(DirtDecayLv3Recipe));
