...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsPineapple : PlantLayerSettings
    {
        public PlantLayerSettingsPineapple() : base()
        {
            ...
            this.Unit = "Pineapple"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Pineapple".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Pineapple : PlantEntity
    {
        ...
        public partial class PineappleSpecies : PlantSpecies
        {
            public PineappleSpecies() : base()
            {
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 4 }); //noloc
