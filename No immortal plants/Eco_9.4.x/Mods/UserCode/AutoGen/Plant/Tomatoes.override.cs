...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsTomatoes : PlantLayerSettings
    {
        public PlantLayerSettingsTomatoes() : base()
        {
            ...
            this.Unit = "Tomatoes"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Tomatoes".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Tomatoes : PlantEntity
    {
        ...
        public partial class TomatoesSpecies : PlantSpecies
        {
            public TomatoesSpecies() : base()
            {
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.2f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.2f }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 2 }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 4 }); //noloc
