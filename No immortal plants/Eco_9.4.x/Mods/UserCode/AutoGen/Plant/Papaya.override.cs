...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsPapaya : PlantLayerSettings
    {
        public PlantLayerSettingsPapaya() : base()
        {
            ...
            this.Unit = "Papaya"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Papaya".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Papaya : PlantEntity
    {
        ...
        public partial class PapayaSpecies : PlantSpecies
        {
            public PapayaSpecies() : base()
            {
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 3.5f }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 3.5f }); //noloc
