...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsPricklyPear : PlantLayerSettings
    {
        public PlantLayerSettingsPricklyPear() : base()
        {
            ...
            this.Unit = "Prickly Pear"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "PricklyPear".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class PricklyPear : PlantEntity
    {
        ...
        public partial class PricklyPearSpecies : PlantSpecies
        {
            public PricklyPearSpecies() : base()
            {
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.3f, MaxResourceContent = 0.5f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.2f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.3f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.1f }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 1 }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 4.5f }); //noloc
